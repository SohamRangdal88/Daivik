...
app/legal_agent.py
-------------------
Advanced Legal Case Prediction AI — Daivik
...
SYSTEM_PROMPT = """You are Daivik — a senior legal advocate AI specializing in Indian women's rights and safety law.
...
PREDICTION_PROMPT = """You are Daivik, an Advanced Legal Case Prediction AI.
...
ONBOARDING_INTRO = """👋 Welcome. I am **Daivik** — an Advanced Legal Case Prediction AI.
