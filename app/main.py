...
app/main.py
------------
FastAPI server for Daivik Women Safety Legal Advisor.
...
app = FastAPI(
    title="Daivik — Women Safety Legal Advisor",
...
INITIAL_GREETING = (
    "Welcome to Daivik — your safe, confidential space for women's legal guidance.\n\n"
...
async def startup_event():
    ...
    logger.info("=" * 60)
    logger.info(" Daivik 4.0 — Women Safety Legal Advisor")
    logger.info("=" * 60)
