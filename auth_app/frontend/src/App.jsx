    ...
    <div style={{
      ...
      <div style={{ padding: '6px 14px 14px' }}>
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: '#78350f', marginBottom: 4 }}>Daivik</div>
...
const MY_DOCUMENTS = [
  { id: 'intake', abbr: 'AI', color: '#2563eb', title: 'Case Intake Summary', meta: 'AI Generated · Today', tags: [{ l: 'AI Generated', c: 'blue' }, { l: 'Current Case', c: 'green' }], desc: 'AI-generated summary of your case including key facts, timeline, parties involved, and identified legal issues.', content: 'This document is auto-generated after your Daivik consultation. Start a conversation to build your case intake summary with all collected facts.', links: [{ label: 'NCW — Online Legal Consultation', url: 'https://ncwapps.nic.in/frmComplaint.aspx' }, { label: 'NALSA — Free Legal Aid', url: 'https://nalsa.gov.in/' }, { label: 'Legal Services India', url: 'http://www.legalservicesindia.com/' }] },
  { id: 'laws', abbr: 'LAW', color: '#7c3aed', title: 'Applicable Laws Report', meta: 'AI Generated · Today', tags: [{ l: 'Legal Analysis', c: 'blue' }, { l: '10 Acts', c: 'amber' }], desc: 'List of Indian laws, IPC sections and court precedents applicable to your specific situation based on the facts you shared.', content: 'Complete a consultation first. Based on your case, Daivik identifies relevant Indian acts, key sections, and applicable precedents from eCourts judgements.', links: [{ label: 'IndianKanoon — Case Law Search', url: 'https://indiankanoon.org/' }, { label: 'India Code — Official Legislation', url: 'https://www.indiacode.nic.in/' }, { label: 'Department of Justice, India', url: 'https://doj.gov.in/' }] },
      ...
      <div className="landing-page">
        ...
        <header className="landing-header" id="top">
          <div className="landing-header-left">
            <div className="landing-brand-text">
              <span className="landing-brand-name landing-wordmark">Daivik</span>
        ...
        <section className="landing-hero">
          ...
          <div className="landing-hero-left">
            ...
            <h1 className="landing-hero-title">
              ...
              <span className="accent">Speak with Daivik.</span>
            </h1>

            <p className="landing-hero-sub">
              Daivik is a confidential first step for women who want to understand their legal
        ...
        <section className="landing-about" id="about">
          <div className="landing-about-inner">
            ...
            <p>
              ...
              have a case?"</em> Daivik exists to answer that — privately, in plain language, before
          ...
          <div className="landing-developer-card">
            ...
            <div>
              ...
              <p className="landing-developer-bio">
                Developer of the Daivik platform — designing and building the product end-to-end.
              </p>
        ...
        <footer className="landing-footer-big" id="site-footer">
          <div className="landing-footer-grid">
            <div className="landing-footer-col landing-footer-brand">
              <div className="landing-footer-brand-row">
                <span className="landing-brand-name landing-wordmark" style={{ color: '#fff' }}>Daivik</span>
              </div>
            ...
            <div className="landing-footer-col">
              ...
              <button onClick={() => setGuestModalOpen(true)}>Chat with Daivik</button>
          ...
          <div className="landing-footer-bottom">
            <span>© 2025 Daivik Project. All rights reserved.</span>
      ...
      <aside className={`app-sidebar${sidebarOpen ? ' open' : ''}`}>
        <div className="sidebar-top">
          <div className="sidebar-brand" onClick={() => setShowLanding(true)} style={{ cursor: 'pointer' }}>
            <span className="sidebar-brand-name landing-wordmark">Daivik</span>
          </div>
        ...
        <div className="top-bar no-print">
          <div className="top-bar-left">
            ...
            <div className="top-bar-brand">
              <span className="top-bar-name landing-wordmark">Daivik</span>
            </div>
          </div>
                ...
                <div className="messages-inner">
                  ...
                  {showWelcome && (
                    <div className="welcome-screen">
                      <h2 className="welcome-heading">How Daivik Can Help</h2>
                          ...
                          <div className="msg-body" style={{ maxWidth: '100%', flex: 1 }}>
                            ...
                            <div className="analysis-card">
                              <div className="analysis-card-header">
                                ...
                                <span className="analysis-card-header-title">Daivik Legal Analysis</span>
          ...
          <div className="composer-wrap no-print">
            <div className="composer">
              ...
              <textarea
                ...
                placeholder={lang === 'hi' ? 'अभयAI से कुछ भी पूछें…' : lang === 'mr' ? 'अभयAI ला काहीही विचारा…' : 'Ask Daivik anything…'}
                disabled={loading}
                rows={1}
              />
